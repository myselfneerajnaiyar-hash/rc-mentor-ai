"use client";
import { Brain, Target, Skull, TrendingUp, ShieldAlert, Sparkles } from "lucide-react";

export default function DailyRCCognitiveDiagnosis({ data }) {
  const { questions, responses: attempts } = data;
  ...
  return (
    <section className="text-white" aria-label="Cognitive diagnosis content">
