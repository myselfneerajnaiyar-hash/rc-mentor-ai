import { isWhatsAppSenderReady } from "./events/config.js"
...
export async function sendTemplateMessage(
  ...
  { env = process.env, fetchImpl = globalThis.fetch, timeoutMs = 10000 } = {}
) {
  const gate = getSenderGate(env)
...
export function getSenderGate(env = process.env) {
