...
import { AlertTriangle, Check, ChevronDown, ChevronLeft, ChevronRight, Eye } from "lucide-react";

export default function DailyRCDetailedReview({ data }) {
  const { attempt: { id: attemptId }, rcSet, questions = [], responses: attempts = [] } = data;
  ...
  return (
    <section className="text-white" aria-label="Detailed review content">
