...
import { normalizeWhatsAppPhoneE164 } from "../phone.js"
...
export function serializeEvent(event) {
  ...
  const phone = event.phoneSnapshot ? normalizeWhatsAppPhoneE164(event.phoneSnapshot) : null
  if (phone && !phone.ok) throw new Error(phone.message)
  return {
    ...
    payload,
    phone_snapshot: phone?.phone || null,
