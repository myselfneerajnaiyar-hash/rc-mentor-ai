  ...
  return (
    <>
      ...
      <main className="relative min-h-screen bg-[#0b1020] text-white overflow-hidden">
        ...
        {/* BACKGROUND GLOW */}
        <div className="absolute top-[-250px] left-1/2 -translate-x-1/2 w-[900px] h-[900px] bg-blue-500/10 blur-[180px] rounded-full pointer-events-none" />
        ...
        <section className="max-w-6xl mt-20 mx-auto px-6 pt-28 pb-24 text-center">
          ...
          <p className="text-gray-300 text-xl leading-relaxed max-w-3xl mx-auto">
            Structured RC training, AI mentorship, analytics,
            and daily practice designed for serious aspirants.
          </p>
